...
const _hoisted_6 = { class: "d-flex align-center px-3 py-2" };
const _hoisted_7 = { class: "channel-meta" };
const _hoisted_8 = { class: "text-body-2 font-weight-medium text-truncate" };
const _hoisted_9 = { class: "text-caption text-medium-emphasis text-truncate" };
const _hoisted_10 = {
  key: 1,
  class: "empty-state"
};
const _hoisted_11 = { class: "d-flex align-center mb-2" };
const _hoisted_12 = {
  key: 0,
  class: "channel-list"
};
const _hoisted_13 = { class: "d-flex align-center px-3 py-2" };
const _hoisted_14 = { class: "channel-meta" };
const _hoisted_15 = { class: "text-body-2 font-weight-medium text-truncate" };
const _hoisted_16 = { class: "text-caption text-medium-emphasis text-truncate" };
const _hoisted_17 = {
  key: 1,
  class: "empty-state"
};
...
const _hoisted_20 = { class: "d-flex align-center justify-center" };
const _hoisted_21 = { class: "text-body-2 text-medium-emphasis" };
const _hoisted_22 = { class: "d-flex align-center px-2 py-1 flex-wrap" };
      ...
      default: _withCtx(() => [
        ...
        _createVNode(_component_v_card_text, { class: "px-4 py-4" }, {
          default: _withCtx(() => [
            ...
            _cache[36] || (_cache[36] = _createElementVNode("div", { class: "section-label mb-2" }, "插件设置", -1)),
            _createVNode(_component_v_row, null, {
              default: _withCtx(() => [
                _createVNode(_component_v_col, {
                  cols: "12",
                ...
                _createVNode(_component_v_col, {
                  ...
                  default: _withCtx(() => [
                    _cache[33] || (_cache[33] = _createElementVNode("div", { class: "mr-2" }, [
                ...
                _createVNode(_component_v_col, {
                  ...
                  default: _withCtx(() => [
                    _createVNode(_component_v_text_field, {
                      ...
                      "onUpdate:modelValue": _cache[6] || (_cache[6] = $event => ((config.delay_seconds) = $event)),
                      label: "触发延迟（秒）",
                      variant: "outlined",
                      density: "comfortable",
                      type: "number",
                ...
                _createVNode(_component_v_col, {
                  ...
                  default: _withCtx(() => [
                    _cache[34] || (_cache[34] = _createElementVNode("span", { class: "text-body-2 mr-2" }, "转存成功通知", -1)),
                    _createVNode(_component_v_switch, {
                      modelValue: config.notify_success,
                      "onUpdate:modelValue": _cache[7] || (_cache[7] = $event => ((config.notify_success) = $event)),
                      color: "primary",
                      "hide-details": "",
                      density: "compact"
                    }, null, 8, ["modelValue"])
                ...
                _createVNode(_component_v_col, {
                  ...
                  default: _withCtx(() => [
                    _cache[35] || (_cache[35] = _createElementVNode("span", { class: "text-body-2 mr-2" }, "未命中通知", -1)),
                    _createVNode(_component_v_switch, {
                      modelValue: config.notify_fail,
                      "onUpdate:modelValue": _cache[8] || (_cache[8] = $event => ((config.notify_fail) = $event)),
                      color: "primary",
                      "hide-details": "",
                      density: "compact"
                    }, null, 8, ["modelValue"])
        ...
        _createVNode(_component_v_window, {
          ...
          default: _withCtx(() => [
            _createVNode(_component_v_window_item, {
              ...
              default: _withCtx(() => [
                ...
                _createVNode(_component_v_text_field, {
                  ...
                  "onUpdate:modelValue": _cache[10] || (_cache[10] = $event => ((transferUrl).value = $event)),
                  label: "115 分享链接",
                ...
                _createVNode(_component_v_text_field, {
                  ...
                  "onUpdate:modelValue": [
                    _cache[11] || (_cache[11] = $event => ((transferTarget).value = $event)),
                ...
                _createElementVNode("div", _hoisted_3, [
                  ...
                  _createVNode(_component_v_btn, {
                    variant: "outlined",
                    "prepend-icon": "mdi-folder-open",
                    onClick: _cache[12] || (_cache[12] = $event => (openDirBrowser('transfer')))
                  }, {
              ...
              default: _withCtx(() => [
                ...
                _createElementVNode("div", _hoisted_4, [
                  _createVNode(_component_v_text_field, {
                    ...
                    "onUpdate:modelValue": _cache[13] || (_cache[13] = $event => ((searchKeyword).value = $event)),
                    label: "搜索关键字（影片名 + 年份）",
                    variant: "outlined",
                    density: "comfortable",
                    "hide-details": "",
                          ...
                          default: _withCtx(() => [
                            _createElementVNode("div", _hoisted_6, [
                              ...
                              _createElementVNode("div", _hoisted_7, [
                                ...
                                _createElementVNode("div", _hoisted_9, _toDisplayString(r.channel) + " · " + _toDisplayString(r.share_url), 1)
                              ]),
                              _createVNode(_component_v_btn, {
                                color: "primary",
                                variant: "tonal",
            ...
            _createVNode(_component_v_window_item, {
              ...
              default: _withCtx(() => [
                _cache[52] || (_cache[52] = _createElementVNode("div", { class: "section-label mb-2" }, "添加频道", -1)),
                _createVNode(_component_v_card, {
                  variant: "tonal",
                  color: "primary",
                  rounded: "lg",
                ...
                _createElementVNode("div", _hoisted_11, [
                  _cache[49] || (_cache[49] = _createElementVNode("span", { class: "section-label" }, "已添加频道", -1)),
                  _createVNode(_component_v_chip, {
                    size: "small",
                    variant: "tonal",
                    class: "ml-2"
                ...
                (channels.value.length)
                          ...
                          default: _withCtx(() => [
                            _createElementVNode("div", _hoisted_13, [
                              ...
                              _createElementVNode("div", _hoisted_14, [
                                _createElementVNode("div", _hoisted_15, _toDisplayString(ch.name), 1),
                                _createElementVNode("div", _hoisted_16, _toDisplayString(ch.id), 1)
                              ]),
                              _createVNode(_component_v_btn, {
                                icon: "",
                                variant: "text",
                  ...
                  : (_openBlock(), _createElementBlock("div", _hoisted_17, [
                      ...
                      _cache[51] || (_cache[51] = _createElementVNode("div", { class: "text-body-2" }, "暂未添加任何 TG 频道", -1))
                    ]))
              ]),
              _: 1
            })
          ...
          default: _withCtx(() => [
            _createVNode(_component_v_card_title, { class: "d-flex align-center px-4 py-3" }, {
              default: _withCtx(() => [
                ...
                _cache[53] || (_cache[53] = _createTextVNode("批量导入频道 ", -1))
              ]),
              _: 1
            }),
            _createVNode(_component_v_divider),
          ...
          default: _withCtx(() => [
            _createVNode(_component_v_card_title, { class: "d-flex align-center px-4 py-3" }, {
              default: _withCtx(() => [
                ...
                _cache[56] || (_cache[56] = _createTextVNode("确认删除 ", -1))
              ]),
              _: 1
            }),
            _createVNode(_component_v_divider),
          ...
          default: _withCtx(() => [
            _createVNode(_component_v_card_title, { class: "d-flex align-center px-4 py-3" }, {
              default: _withCtx(() => [
                ...
                _cache[61] || (_cache[61] = _createTextVNode("115 扫码登录 ", -1))
              ]),
              _: 1
            }),
            _createVNode(_component_v_divider),
              ...
              default: _withCtx(() => [
                ...
                _createElementVNode("div", _hoisted_20, [
                  (qrPolling.value)
                    ...
                    : _createCommentVNode("", true),
                  _createElementVNode("span", _hoisted_21, _toDisplayString(qrMsg.value || '请使用 115 客户端扫码'), 1)
                ])
              ]),
              _: 1
            }),
          ...
          default: _withCtx(() => [
            _createVNode(_component_v_card_title, { class: "d-flex align-center px-4 py-3" }, {
              default: _withCtx(() => [
                ...
                _cache[64] || (_cache[64] = _createTextVNode("选择 115 目录 ", -1))
              ]),
              _: 1
            }),
            _createVNode(_component_v_divider),
            _createVNode(_component_v_card_text, {
              ...
              default: _withCtx(() => [
                _createElementVNode("div", _hoisted_22, [
                  ...
                  (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(dirBrowserPath.value.slice(1), (p, i) => {
                    return (_openBlock(), _createElementBlock(_Fragment, { key: i }, [
                      ...
                      _createElementVNode("span", _hoisted_23, _toDisplayString(p.name), 1)
                    ], 64))
                  }), 128)),
                  _createVNode(_component_v_spacer),
                ...
                (!dirBrowserLoading.value && !dirBrowserDirs.value.length)
                  ? (_openBlock(), _createElementBlock("div", _hoisted_24, "无子目录"))
                  : _createCommentVNode("", true)
              ]),
              _: 1
            }),
            ...
            _createVNode(_component_v_card_actions, { class: "px-4 py-3" }, {
              default: _withCtx(() => [
                _createElementVNode("span", _hoisted_25, "当前: " + _toDisplayString(dirBrowserPathStr.value || '/'), 1),
                _createVNode(_component_v_spacer),
                _createVNode(_component_v_btn, {
                  variant: "text",
...
const Config = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-4deddfb9"]]);
